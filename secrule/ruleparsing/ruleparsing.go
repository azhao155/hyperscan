...
var TargetNamesFromStr = map[string]ast.TargetName{
	...
	"MULTIPART_BOUNDARY_QUOTED":        ast.TargetMultipartBoundaryQuoted,
	"MULTIPART_BOUNDARY_WHITESPACE":    ast.TargetMultipartBoundaryWhitespace,
	"MULTIPART_DATA_AFTER":             ast.TargetMultipartDataAfter,
	"MULTIPART_DATA_BEFORE":            ast.TargetMultipartDataBefore,
	"MULTIPART_FILE_LIMIT_EXCEEDED":    ast.TargetMultipartFileLimitExceeded,
	"MULTIPART_HEADER_FOLDING":         ast.TargetMultipartHeaderFolding,
	"MULTIPART_INVALID_HEADER_FOLDING": ast.TargetMultipartInvalidHeaderFolding,
	"MULTIPART_INVALID_QUOTING":        ast.TargetMultipartInvalidQuoting,
	"MULTIPART_LF_LINE":                ast.TargetMultipartLfLine,
	"MULTIPART_MISSING_SEMICOLON":      ast.TargetMultipartMissingSemicolon,
...
var envVarNamesFromStr = map[string]ast.EnvVarName{
	...
	"multipart_missing_semicolon":      ast.EnvVarMultipartMissingSemicolon, // Note: same as multipart_semicolon_missing
	"multipart_semicolon_missing":      ast.EnvVarMultipartMissingSemicolon, // Note: same as multipart_missing_semicolon
	"multipart_strict_error":           ast.EnvVarMultipartStrictError,
	"multipart_unmatched_boundary":     ast.EnvVarMultipartStrictError,
